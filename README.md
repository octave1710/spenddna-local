...
Three modules
Context Sensing Layer — Aggregates real-time signals: weather, time, location, Payone-style transaction density at nearby merchants
Generative Offer Engine — LLM produces dynamic offer variants (factual / emotional / urgent) with adaptive UI styling — not template fills
Seamless Checkout & Redemption — Dynamic QR codes, simulated cashback to Sparkasse account
Stack
...
Demo
[Demo video link — to be added] [Tech video link — to be added]
